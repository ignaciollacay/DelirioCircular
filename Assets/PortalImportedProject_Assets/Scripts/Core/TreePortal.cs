...
using UnityEngine;
/*
public class TreePortal : MonoBehaviour {
    ...
    void Awake () {
        ...
        treeMeshFilter = screen.GetComponent<MeshFilter>();
        screen.material.SetInt ("displayMask", 1);
        tree.material.SetInt("displayMask", 1);
    }
    ...
    public void Render () {
        ...
        tree.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.ShadowsOnly;
        linkedPortal.tree.material.SetInt("displayMask", 0);
        ...
        for (int i = startIndex; i < recursionLimit; i++) {
            ...
            if (i == startIndex) {
                ...
                linkedPortal.tree.material.SetInt("displayMask", 1);
            }
        }

        // Unhide objects hidden at start of render
        screen.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.On;
        tree.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.On;
    }
